...
function getRectangleString(width, height) {
        ...
        let topOfRec = top.substring(0, 1) + upDown.repeat(width - 2) + top.substring(1);
        let middleOfRec = leftRight + ' '.repeat(width-2) + leftRight + '\n';
        let bottomOfRec = bottom.substring(0, 1) + upDown.repeat(width - 2) + bottom.substring(1);
        return topOfRec + middleOfRec.repeat(height - 2) + bottomOfRec;
}
...
function encodeToRot13(str) {
    ...
    return str.replace(/[a-z]/gi, (index) => output[input.indexOf(index)]);
}
